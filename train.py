...
checkpoint = torch.load('weights/Car/car_weights.pth')
...
for epoch in range(epoch_checkpoint, epochs+1): 
    for i, batch in enumerate(data_loader, 0): 
        ...
        print(f'[EP:{epoch+1}/{epochs}][BT:{i+1}/{len(data_loader)}] LossD: {errD:.2f} LossG: {errG:.2f}')


    saveCheckpoint(G, D, optimG, optimD, epoch, 'weights/Car/car_weights.pth')
